...
function ShowAllPOS() {
	...
	for (var CategoryID = 0; CategoryID < CategoriesAndItemsLength; CategoryID++){
		...
		var ItemsLength = Items.length;
			t = t + "<tr><td colspan=2><p style='font-size:20px;font-weight:bold;color:Red;margin-top:30px;margin-bottom:10px;'>" + CategoriesAndItems[CategoryID].Category + "</p></td></tr>";
